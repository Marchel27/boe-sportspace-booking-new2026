                ...
                <form action="#" id="formPenyewa" class="grid grid-cols-1 gap-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="relative group">
                            ...
                            <input type="tel" name="whatsapp" value="08792183123" 
                                class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-blue-500 focus:bg-white outline-none transition-all duration-300 font-semibold text-slate-700" required>
                        </div>
                    </div>
    ...
    <script>
        ...
        function tanyaKonfirmasi() {
            Swal.fire({
                ...
                html: '<p class="text-slate-500 font-medium text-sm">Pastikan data penyewa sudah sesuai sebelum disimpan ke sistem.</p>',
                icon: 'question',
                iconColor: '#2563eb',
                ...
                customClass: {
                    ...
                    cancelButton: 'rounded-xl px-8 py-3 font-bold text-xs tracking-wider text-slate-600'
                }
            }).then((result) => {
        ...
        // Loading Button & Success Message
        function prosesSimpan() {
            ...
            // menampilkan Popup Interaktif "Sedang Memproses"
            Swal.fire({
                ...
                html: `
                    <div class="mt-4 mb-2">
                        ...
                        <p class="text-slate-400 text-[10px] mt-1 tracking-tight">Sedang mendaftarkan reservasi ke sistem BOE-Sport</p>
                    </div>
                `,
            ...
            setTimeout(() => {
                Swal.fire({
                    ...
                    html: '<p class="text-slate-500 font-medium">Data penyewa telah berhasil disimpan.</p>',
                    icon: 'success',
                    iconColor: '#10B981',
                    timer: 1800,
                    showConfirmButton: false,
                    ...
                    willClose: () => {
                        ...
                        container.style.transition = 'all 0.7s cubic-bezier(0.4, 0, 0.2, 1)';
        ...
        function konfirmasiBatal() {
            Swal.fire({
                ...
                html: '<p class="text-slate-500 font-medium text-sm px-4">Data yang telah dimasukkan akan hilang.</p>',
                icon: 'warning',
                iconColor: '#f43f5e',
                showCancelButton: true,
